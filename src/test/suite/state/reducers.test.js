...
suite("Reducers Test Suite", () => {
	...
	suite("taskReducer", () => {
		...
		test("should handle UPDATE_TASK_IN_HISTORY", () => {
			...
			assert.deepStrictEqual(newState, [payload, { id: "task-2", task: "Another Task" }])
		})
		...
		test("should handle DELETE_TASK_FROM_HISTORY", () => {
			...
			assert.deepStrictEqual(newState, [{ id: "task-2", task: "Another Task" }])
		})
	...
	suite("messageReducer", () => {
		...
		test("should handle UPDATE_PARTIAL_MESSAGE", () => {
			...
			assert.deepStrictEqual(newState, [payload, { ts: 456, text: "Another Message" }])
		})
