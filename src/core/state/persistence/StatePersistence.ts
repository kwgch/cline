...
export class StatePersistence {
	...
	async loadPersistedState(): Promise<Partial<AppState>> {
		...
		// Load other state
		const [customInstructions, taskHistory, autoApprovalSettings, browserSettings, chatSettings, userInfo, telemetrySetting] =
			await Promise.all([
 ...
 */
export const getStatePersistence = (context: vscode.ExtensionContext, stateContainer: StateContainer): StatePersistence => {
