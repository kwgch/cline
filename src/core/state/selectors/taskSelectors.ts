 ...
 */
export const selectTaskHistory = (state: AppState): HistoryItem[] => state.taskHistory
 ...
 */
export const selectCurrentTaskId = (state: AppState): string | undefined => state.currentTaskId
